...
validation_gen = validation_datagen.flow_from_directory(validation_dir,
                                                        ...
                                                        class_mode = 'categorical',
                                                        target_size = input_shape[0:2])
#print("Train generator class indices:", train_gen.class_indices) #Checking classes
...
model1.add(Dropout(0.1, seed=2000))
...
#Training while monitoring how long it takes
start2 = time.time()
history2 = model2.fit(train_gen, steps_per_epoch = 45, epochs = 50, 
                      validation_data=validation_gen, 
                      validation_steps = 20, verbose = 2)
end2 = time.time()
